...
#		print("Character ", mistake_char, " made ", char_total_mistakes, " mistakes.")
		for correct_char in corrects:
			if correct_char.has(mistake_char):
				var without_mistakes_percentage = 100 - (roundf((float(char_total_mistakes) / float(correct_char[mistake_char])) * 100.0))
#				print(
#					"Character ", 
#					mistake_char, 
#					" was typed ", 
...
#					" without mistakes.")
	...
	keyboard.color_hint.set_color_hints(color_char_perfect, color_char_90, color_char_50, color_char_below)
